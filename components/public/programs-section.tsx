    ...
    <AnimatedElement variant="fadeInUp">
      <section className="pt-15 sm:pt-22 relative px-4 sm:px-0 md:px-8 bg-background">
        ...
        <div className="sm:flex-1  px-5 py-4">
          ...
          <h1  style={{fontFamily:'Quicksand'}} className="font-semibold sm:font-bold text-2xl sm:text-5xl text-accent">
          ...
          <span className="flex gap-4 items-center justify-center mt-6">
            <span className="w-1/2">
              <Link  style={{fontFamily:'Quicksand'}} href="/about" className=" rounded-xlg text-primary rounded-lg justify-center p-3 flex items-center font-bold bg-primary/10 ">
                Learn More <ArrowRight className="ml-2 w-4 h-4" />
              </Link>
            </span>
            <span className="w-1/2">
              <h1  style={{fontFamily:'Quicksand'}} className="font-bold text-green-900 text-3xl">100% </h1>
              <span  style={{fontFamily:'Quicksand'}} className="text-primary font-semibold">Non-Profitable & Transparent</span>
            </span>
          </span>
        </div>
      </div>
