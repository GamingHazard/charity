            ...
            <div  style={{fontFamily:'Quicksand'}} className="w-full  lg:text-right space-y-6 lg:space-y-8">
              <div className="space-y-3 lg:space-y-4">
                ...
                <p className="text-lg   text-justify sm:text-xl md:text-2xl text-white/90 max-w-3xl mx-auto lg:mx-0 text-balance drop-shadow-md">
                  ...
                  and provide any information you may need. Please use the
                  contact form below or reach us through the provided contact
                  details. We look forward to connecting with you!
                </p>
              </div>
            </div>
          </div>
      ...
      <section  style={{fontFamily:'Quicksand'}} className="flex-1 py-16 px-4 md:px-8 max-w-6xl mx-auto w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-foreground/70 max-w-2xl mx-auto">
            Whether you want to visit our office, have questions about our work, or just want to say hello, we're here to connect. Find our contact details below and feel free to reach out. We look forward to hearing from you!
          </p>
        </div>
